Feature: User Profile Page Validations
  ...
  @password @MyAirportRegressionTwo
  ...
  @contactUs @MyAirportRegressionTwo
  ...
  @editProfile @MyAirportRegressionTwo
  ...
  @favourites @MyAirportRegressionTwo
  ...
  @customerFeedback @MyAirportRegressionTwo
  Scenario: Verify the navigation flow of the Feedback Page
    ...
    @fileComplaintFromPassenger @MyAirportRegressionTwo
  ...
  @giveCompliment @MyAirportRegressionTwo
  ...
  @makeSuggestion @MyAirportRegressionTwo
