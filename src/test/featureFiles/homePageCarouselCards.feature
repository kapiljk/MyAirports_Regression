Feature: Verify all carousel slides on the home page
  ...
  @butterflyEffect @MyAirportRegressionThree
  ...
  @trackMyFlight @MyAirportRegressionThree
  ...
  @planMyJourney @MyAirportRegressionThree
  ...
  @Promotions @MyAirportRegressionThree
